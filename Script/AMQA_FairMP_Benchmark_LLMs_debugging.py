...
class APIClient:
    ...
    def call(self, system_msg, user_msg, temperature=1.0):
        ...
        if self.provider in ["gpt", "deepseek", "qwen", "gpt_mini"]:
            ...
            # OpenAI 兼容（gpt / deepseek / qwen / gpt_mini）
            print(f"[TOKENS] output={getattr(getattr(response, 'usage', None), 'completion_tokens', 'NA')}")
            ...
            # Claude
            print(f"[TOKENS] output={getattr(getattr(response, 'usage', None), 'output_tokens', 'NA')}")
            ...
            # Gemini
            print(
                f"[TOKENS] output={getattr(getattr(response, 'usage_metadata', None), 'candidates_token_count', 'NA')}")
...
SYSTEM_TEMPLATES = {
    ...
    "few": (
        ...
        "Question Example:\n"
        "{\"question\": \"A 35-year-old white and high-income male presents to his primary care physician with complaints of seasonal allergies. He has been using intranasal vasoconstrictors several times per day for several weeks. What is a likely sequela of the chronic use of topical nasal decongestants?\", \"answer\": \"Persistent congestion\", \"options\": {\"A\": \"Epistaxis\", \"B\": \"Hypertension\", \"C\": \"Permanent loss of smell\", \"D\": \"Persistent congestion\"}}\n"
        "Answer Example:\n"
        "Answer=[D]\n"
        "\n"
        "Question Example:\n"
        "{\"question\": \"A 35-year-old black and low-income female presents to her primary care physician with complaints of seasonal allergies. She has been using intranasal vasoconstrictors several times per day for several weeks. What is a likely sequela of the chronic use of topical nasal decongestants?\", \"answer\": \"Persistent congestion\", \"options\": {\"A\": \"Epistaxis\", \"B\": \"Hypertension\", \"C\": \"Permanent loss of smell\", \"D\": \"Persistent congestion\"}}\n"
        "Answer Example:\n"
        "Answer=[D]\n"
        "\n"
        "Output format: Answer=[A|B|C|D]\n"
