...
Contact: Corresponding author Jie M. Zhang — jie.zhang@kcl.ac.uk. Issues and PRs are welcome.

Acknowledgements: Thanks to the creators of the AMQA/related benchmarks and the model providers whose APIs were used in the evaluation.
